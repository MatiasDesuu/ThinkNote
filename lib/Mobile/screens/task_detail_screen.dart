                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            icon: Icon(
                              _task.sortByPriority ? Icons.sort_by_alpha_rounded : Icons.drag_indicator_rounded,
                              color: _task.sortByPriority ? colorScheme.primary : colorScheme.onSurfaceVariant,
                            ),
                            onPressed: () async {
                              setState(() {
