...
class NotebookIconsRepository {
  static const List<NotebookIcon> icons = [
    ...
    NotebookIcon(id: 245, icon: FontAwesomeIcons.bookOpen, name: 'Book Open'),
    ...
    NotebookIcon(id: 251, icon: Icons.inventory_2_rounded, name: 'Inventory'),
    NotebookIcon(id: 252, icon: Icons.inbox_rounded, name: 'Inbox'),
    NotebookIcon(id: 253, icon: Icons.account_tree_rounded, name: 'Hierarchy'),
    NotebookIcon(id: 254, icon: Icons.category_rounded, name: 'Categories'),
    NotebookIcon(id: 255, icon: Icons.filter_alt_rounded, name: 'Filter'),
    NotebookIcon(id: 256, icon: Icons.sort_rounded, name: 'Sort'),
    NotebookIcon(id: 257, icon: Icons.view_module_rounded, name: 'Modules'),
    NotebookIcon(id: 258, icon: Icons.view_kanban_rounded, name: 'Kanban'),
    NotebookIcon(id: 259, icon: Icons.view_timeline_rounded, name: 'Timeline'),

    NotebookIcon(id: 260, icon: Icons.terminal_rounded, name: 'Terminal'),
    NotebookIcon(id: 261, icon: Icons.bug_report_rounded, name: 'Bug / Debug'),
    NotebookIcon(id: 262, icon: Icons.data_object_rounded, name: 'Data Object'),
    NotebookIcon(id: 263, icon: Icons.api_rounded, name: 'API'),
    NotebookIcon(
      id: 264,
      icon: Icons.integration_instructions_rounded,
      name: 'Integration',
    ),
    NotebookIcon(id: 265, icon: Icons.webhook_rounded, name: 'Webhook'),
    NotebookIcon(id: 266, icon: Icons.source_rounded, name: 'Source Code'),
    NotebookIcon(id: 267, icon: Icons.commit_rounded, name: 'Commit'),
    NotebookIcon(id: 268, icon: Icons.dns_rounded, name: 'Server'),
    NotebookIcon(id: 269, icon: FontAwesomeIcons.database, name: 'Database'),
    NotebookIcon(id: 270, icon: FontAwesomeIcons.python, name: 'Python'),
    NotebookIcon(id: 271, icon: FontAwesomeIcons.java, name: 'Java'),
    NotebookIcon(id: 272, icon: FontAwesomeIcons.js, name: 'JavaScript'),
    NotebookIcon(id: 273, icon: FontAwesomeIcons.react, name: 'React'),
    NotebookIcon(id: 274, icon: FontAwesomeIcons.linux, name: 'Linux'),
    NotebookIcon(id: 275, icon: FontAwesomeIcons.apple, name: 'Apple'),
    NotebookIcon(id: 276, icon: FontAwesomeIcons.windows, name: 'Windows'),
    NotebookIcon(id: 277, icon: FontAwesomeIcons.docker, name: 'Docker'),
    NotebookIcon(id: 278, icon: FontAwesomeIcons.aws, name: 'AWS'),
    NotebookIcon(id: 279, icon: FontAwesomeIcons.gitlab, name: 'GitLab'),
    ...
    NotebookIcon(id: 281, icon: Icons.flag_circle_rounded, name: 'Milestone'),
    NotebookIcon(id: 282, icon: Icons.checklist_rounded, name: 'Checklist'),
    NotebookIcon(
      id: 283,
    ...
    NotebookIcon(id: 285, icon: Icons.insights_rounded, name: 'Insights'),
    NotebookIcon(
      id: 286,
      icon: Icons.track_changes_rounded,
      name: 'Track Changes',
    ),
    NotebookIcon(id: 287, icon: Icons.handshake_rounded, name: 'Deal'),
    NotebookIcon(id: 288, icon: Icons.gavel_rounded, name: 'Rules'),
    ...
    NotebookIcon(id: 290, icon: Icons.draw_rounded, name: 'Draw'),
    NotebookIcon(id: 291, icon: Icons.drafts_rounded, name: 'Drafts'),
    NotebookIcon(id: 292, icon: Icons.local_library_rounded, name: 'Reading'),
    NotebookIcon(id: 293, icon: Icons.feed_rounded, name: 'News Feed'),
    NotebookIcon(id: 294, icon: FontAwesomeIcons.penNib, name: 'Pen Nib'),
    NotebookIcon(id: 295, icon: FontAwesomeIcons.feather, name: 'Feather'),
    NotebookIcon(
      id: 296,
      icon: FontAwesomeIcons.bookOpenReader,
      name: 'Reader',
    ),
    NotebookIcon(id: 297, icon: Icons.publish_rounded, name: 'Publish'),
    NotebookIcon(id: 298, icon: Icons.book_online_rounded, name: 'Online Book'),
    NotebookIcon(id: 299, icon: Icons.subtitles_rounded, name: 'Subtitles'),
    NotebookIcon(id: 300, icon: Icons.import_contacts_rounded, name: 'Journal'),
  ];
